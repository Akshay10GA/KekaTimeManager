...
const quizData = {
  ...
  {
    "question": "Modi ji ne bola 'Cloud se chhup ke drone udayenge kyunki radar nahi pakadta', Indian Air Force ka pilot kya sochega?",
  ...
  {
    "question": "Kejriwal ji ne bola 'Main IITian hoon, bijli free ka formula khud banaya', IIT alumni group chat mein kya message aaya?",
  ...
  {
    "question": "Kangana Ranaut ne bola 'Freedom 2014 mein mili hai', 1947 wale freedom fighters ne kya kiya?",
  ...
  {
    "question": "Sambit Patra ne bola 'Indira is India, India is Indira', fir realize kiya galti se Congress wala quote bol diya, kya kiya?",
    "options": ["Godi media ne mute kar diya", "Damage control mein 'Modira' bol diya", "Twitter se delete", "Arre mic kharab tha"],
    "answer": "Damage control mein 'Modira' bol diya"
  },
  {
    "question": "Hema Malini ne Mathura mein bola 'Main yahan paani laungi', kisan ne kya poocha?",
  ...
  {
    "question": "Supriya Shrinate ne Kangana pe personal comment kiya, fir sorry bola, Kangana ne kya reply diya?",
    "options": ["Main toh ladki hoon lad sakti hoon", "Emergency laga dungi", "Tejaswini se bhaari hoon", "Oscar wapas le lo"],
    "answer": "Emergency laga dungi"
  },
  {
    "question": "Sunny Deol ne Gurdaspur se bola 'Dhai kilo ka haath' aur jeet gaye, voter ne kya socha?",
  ...
  {
    "question": "Arvind Kejriwal ne bola 'Main aam aadmi hoon', fir 10 crore ka sheeshmahal banwaya, aam aadmi ne kya poocha?",
  ...
  {
    "question": "Yogi Adityanath ne bola 'Baba ka bulldozer', bulldozer driver ne kya poocha?",
  ...
  {
    "question": "Shashi Tharoor ne tweet kiya 'Cattle class', fir bole sorry, cow vigilante ne kya kiya?",
  ...
  {
    "question": "Gautam Gambhir ne bola 'Smile please' ad mein, fir opposition ko gali di, brand ne kya kiya?",
